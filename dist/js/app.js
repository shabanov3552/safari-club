 ...
 */
    ...
    (() => {
        ...
        function promotionOpen(target) {
            ...
            if (target.closest(".promotion__dd-link")) _slideToggle(dropDown, 300);
            if (!target.closest(".promotion__dd-link") && !target.closest(".promotion__dd")) _slideUp(dropDown, 300);
            if (target.closest(".promotion__button")) _slideUp(dropDown, 300);
        }
        ...
        class YouTubeVideoPreview {
            ...
            getVideoData() {
                ...
                if ("error" === res.status) console.error(res); else res.then((json => {
        ...
        function addLoadedClass() {
            window.addEventListener("load", (function() {
                setTimeout((function() {
                    ...
                    if (document.querySelector(".video-block")) window.playMainVideo();
                }), 0);
            }));
        }
        ...
        function tabs() {
            ...
            function setTabsAction(e) {
                ...
                if (el.closest("[data-tabs-title]")) {
                    ...
                    if (!el.closest(".rest-menu__link")) e.preventDefault();
                }
            }
        }
        function menuInit() {
        ...
        function initSliders() {
            if (document.querySelector(".swipe")) new core(".swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelectorAll(".rest-menu__slider").length > 0) {
